...
2. `docs/CONTEXT.md` — glossary (skill / agent / convention / stance / learning / reference /
   pipeline). Single context — **no packages**.
...
4. **Before editing:** consult `docs/conventions/INDEX.md` (starts empty).
